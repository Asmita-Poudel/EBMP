...
class MusicPlayer(object):
    ...
    def __init__(self, root, emotionStr):
        ...
        trackstatus = Label(trackframe, textvariable=self.status, font=("times new roman", 18, "bold"), bg="grey",
                            fg="gold").grid(row=0, column=1, padx=5, pady=5)
        ...
        playbtn = Button(buttonframe, text="SHUFFLE", command=self.shufflesong, width=10, height=1,
        ...
        playbtn = Button(buttonframe, text="STOP", command=self.stopsong, width=6, height=1,
                         font=("times new roman", 16, "bold"), fg="navyblue", bg="gold").grid(row=0, column=3, padx=10,
                                                                                              pady=5)
        playbtn = Button(buttonframe, text="NEXT", command=self.nextsong, width=6, height=1,
                         font=("times new roman", 16, "bold"), fg="navyblue", bg="gold").grid(row=0, column=4, padx=10,
                                                                                              pady=5)
        ...
        os.chdir(str(Path(__file__).parent.absolute()) + "/data/archive (1)/" + emotionStr + "\\")
        # Fetching Songs
